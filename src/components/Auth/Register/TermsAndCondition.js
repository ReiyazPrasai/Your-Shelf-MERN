...
import { Row, Col, Descriptions, Checkbox } from "antd";
...
const TermsAndCondition = (props) => {
  ...
  return (
    <div className={"login-wrapper"} style={{ width: "100%" }}>
        ...
        >
          <ol style={{ fontSize: ".6rem" }}>
            ...
            <li>
              ...
              (if users can't have an account with you) can be terminated in
            ...
            <li>
              ...
              the country from which you operate your website and mobile app.
            </li>
            <li>
            ...
            <li>
              ...
              make that content public to other users, a Content section will
              inform users that they own the rights to the content they have
              created. The "Content" clause usually mentions that users must
              give you (the website or mobile app developer) a license so that
              you can share this content on your website/mobile app and to make
            ...
            <li>
              ...
              Terms and Conditions agreements so as to encompass the most amount
              of negative uses.
            </li>
          </ol>
      ...
      <div style={{ width: "100%", marginTop: 10, paddingLeft: 20 }}>
        <Row>
          <Col>
            <Checkbox
              checked={props.isTermsChecked}
              onChange={(e) => {
                props.setIsTermsChecked(e.target.checked);
              }}
              style={{ marginRight: 6 }}
            />{" "}
            Accept All the terms & conditions to register
          </Col>
        </Row>
      </div>
    </div>
