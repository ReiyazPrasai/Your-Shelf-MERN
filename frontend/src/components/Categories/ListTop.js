...
const ListTop = (props) => {
  const { setListQuery, listQuery, fetchCategoryList } = props;
  ...
  const handleSearch = (e) => {
    ...
    fetchCategoryList(getQuery(formData, listQuery));
  };

  return (
    <Row gutter={8}>
      <Col xxl={6} xl={!isClearSearch?7:6} lg={8} md={8} sm={!isClearSearch?24:12} xs={24}>
      ...
      <Col xxl={4} xl={4} lg={8} md={8} sm={!isClearSearch?12:24} xs={!isClearSearch ? 12 : 24}>
        <Button
